...
cafe_game: Barista.cpp Cafe.cpp Chef.cpp Cleaner.cpp Consumable.cpp Customer.cpp Employee.cpp Game.cpp KitchenStaff.cpp main.cpp Player.cpp Table.cpp Waiter.cpp
	g++ -std=c++11 Barista.cpp Cafe.cpp Chef.cpp Cleaner.cpp Consumable.cpp Customer.cpp Employee.cpp Game.cpp KitchenStaff.cpp main.cpp Player.cpp Table.cpp Waiter.cpp -lsfml-graphics -lsfml-window -lsfml-system -ljsoncpp -o cafe_game
